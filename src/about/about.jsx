...
export default function about() {
  return (
    <div className='about'>
        ...
        <div className='right'>
            <h1>About US</h1>
            <p className='content'>Welcome to Rk photoStudios when you go-to destination for all things related to Photoshop! Whether you're a beginner or a seasoned professional, we are here to help you elevate your design game with expert tutorials, creative resources, and helpful tips.
